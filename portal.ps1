function TypeTextObject {
    ...
    .LINK
        https://github.com/justin-p/PowerShell/blob/master/Portal.ps1
#>    
    Param(
        [string]$Text,
        [switch]$newline,
...
Function Play-Portal {
<#
    .NOTES
        Author: Justin Perdok (@JustinPerdok), https://justin-p.me.
        License: MIT
        
        Inspired/based on http://www.leeholmes.com/projects/ps_html5/Invoke-PSHtml5.ps1
