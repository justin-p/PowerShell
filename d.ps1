...
$arg = "-Notes 'R0H,G6E,F#6E,E6E,E6E,F#6H,R0H,R0Q,R0E,A5E,G6E,F#6E,E6E,E6E,F#6Q.,D6Q,E6E,A5H,R5E,R0Q.,A5E,E6Q,F#6E,G6Q.,E6E,C#6Q,D6Q.,E6Q,A5E,A5Q,F#6Q.,R0H,R0H,G6E,F#6E,E6E,E6E,F#6H,R0H,R0Q,R0E,A5E,G6E,F#6E,E6E,E6Q,F#6E,D6Q.,E6E,A5H'"
...
TypeText -Text "We do what we must" -newline -sleep 50
start-sleep -Milliseconds 350
TypeText -Text "because we can." -newline 
#start-sleep -Milliseconds 1500
#TypeText -Text "For the good of all of us."
#start-sleep -Milliseconds 1500
#TypeText -Text "Except the ones who are dead."
#start-sleep -Milliseconds 1500
#TypeText -Text "But there's no sense crying"
#start-sleep -Milliseconds 1500
#TypeText -Text "over every mistake."
#start-sleep -Milliseconds 1500
#TypeText -Text "You just keep on trying"
#start-sleep -Milliseconds 1500
#TypeText -Text "till you run out of cake."
#start-sleep -Milliseconds 1500
#TypeText -Text "And the Science gets done."
#start-sleep -Milliseconds 1500
#TypeText -Text "And you make a neat gun."
#start-sleep -Milliseconds 1500
#TypeText -Text "For the people who are"
#start-sleep -Milliseconds 1500
#TypeText -Text "still alive."
#start-sleep -Milliseconds 1500
#TypeText -Text ""
#
